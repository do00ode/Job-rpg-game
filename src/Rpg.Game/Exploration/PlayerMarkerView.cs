...
{
	private const double StepDurationSeconds = 0.264;
	...
	public override void _Draw()
	{
		...
		{
			// Source frames fit the native 16x16 exploration cell. Keep each frame at
			// native size so the 13x16 side artwork retains its authored proportions.
